...
export const DEFAULT_PRESET_ITEMS = [
  ...
  { itemId: 'garrafa_agua_impura', name: 'Garrafa de Água Impura', icon: '🧪', category: 'supplies', rarity: 'common', consumable: true, consumeEffect: { thirst: 25 }, returnItemOnConsume: 'garrafa_vazia', isQuestItem: false, description: 'Água turva de fonte natural. Pode ser bebida para matar a sede em desespero, mas acarreta alto risco de infecção gastrointestinal. Ferva na cozinha para purificar.' },
  { itemId: 'multivitaminico', name: 'Frasco de Multivitamínicos', icon: '💊', category: 'medical', rarity: 'uncommon', consumable: true, maxUses: 3, canTargetOther: true, consumeEffect: { blood: 10 }, cureDiseases: ['gripe', 'resfriado'], relieveSymptoms: ['cansaco'], isQuestItem: false, description: 'Complexo vitamínico concentrado (3 usos). Fortalece o sistema imunológico e cura gripe e resfriados.' },
  { itemId: 'tetraciclina', name: 'Tetraciclina (Antibiótico)', icon: '💊', category: 'medical', rarity: 'rare', consumable: true, maxUses: 2, canTargetOther: true, consumeEffect: { blood: 15 }, cureDiseases: ['infeccao_intestinal', 'pneumonia', 'gastroenterite'], relieveSymptoms: ['dor_abdominal', 'diarreia'], isQuestItem: false, description: 'Antibiótico potente de amplo espectro (2 usos). Trata infecção intestinal severa, pneumonia e gastroenterite.' },
  { itemId: 'carvao_ativado', name: 'Carvão Ativado', icon: '⚫', category: 'medical', rarity: 'common', consumable: true, maxUses: 2, canTargetOther: true, consumeEffect: { blood: 5 }, cureDiseases: ['gastroenterite'], relieveSymptoms: ['nausea', 'dor_abdominal'], isQuestItem: false, description: 'Pastilhas de carvão ativado (2 usos). Absorve toxinas estomacais e cura gastroenterite aguda.' },
  { itemId: 'antitermico', name: 'Antitérmico & Analgésico', icon: '💊', category: 'medical', rarity: 'common', consumable: true, maxUses: 2, canTargetOther: true, consumeEffect: { blood: 10 }, cureDiseases: [], relieveSymptoms: ['febre', 'calafrios', 'tosse'], isQuestItem: false, description: 'Medicamento contra febre e dores corporais (2 usos). Alivia febre alta e calafrios intensos.' },
  ...
  { itemId: 'kit_armadilhas', name: 'Kit de Armadilhas Mecânicas', icon: '🐺', category: 'tools', rarity: 'uncommon', consumable: false, isQuestItem: false, description: 'Arapucas e laços para captura de animais de pequeno porte.' },
  ...
  { itemId: 'ferramentas_agricolas', name: 'Conjunto de Ferramentas Agrícolas', icon: '🧑‍🌾', category: 'tools', rarity: 'uncommon', consumable: false, isQuestItem: false, equipSlot: 'hands_weapon', damageMin: 12, damageMax: 18, maxDurability: 120, durability: 120, description: 'Enxada e foice manual para manejo de plantio.' },
  ...
  // =========================================================================
  { itemId: 'vara_pesca', name: 'Vara de Pesca', icon: '🎣', category: 'tools', rarity: 'uncommon', consumable: false, isQuestItem: false, equipSlot: 'accessory', maxDurability: 150, durability: 150, description: 'Vara artesanal de bambu com linha e anzol. Necessária para pescar.' },
  { itemId: 'enxada', name: 'Enxada', icon: '⛏️', category: 'tools', rarity: 'uncommon', consumable: false, isQuestItem: false, equipSlot: 'accessory', maxDurability: 120, durability: 120, description: 'Ferramenta agrícola para cavar solo e plantar sementes.' },
  ...
  { itemId: 'semente_tomate', name: 'Semente de Tomate', icon: '🍅', category: 'supplies', rarity: 'common', consumable: false, isQuestItem: false, description: 'Semente para plantar tomate na horta.' },
  { itemId: 'semente_milho', name: 'Semente de Milho', icon: '🌽', category: 'supplies', rarity: 'common', consumable: false, isQuestItem: false, description: 'Semente para plantar milho na horta.' },
  { itemId: 'semente_batata', name: 'Semente de Batata', icon: '🥔', category: 'supplies', rarity: 'common', consumable: false, isQuestItem: false, description: 'Tubérculo-semente para plantar batatas.' },
  ...
  // =========================================================================
  // MATERIAIS DE CONSTRUÇÃO & MELHORIA DO ACAMPAMENTO
  // =========================================================================
  { itemId: 'material_madeira', name: 'Madeira', icon: '🪵', category: 'supplies', rarity: 'common', consumable: false, isQuestItem: false, description: 'Tábuas, ripas e toras resistentes para obras, barricadas e recuperação estrutural.' },
  { itemId: 'material_metal', name: 'Metal', icon: '🔩', category: 'supplies', rarity: 'common', consumable: false, isQuestItem: false, description: 'Pregos, parafusos, dobradiças e chapas metálicas essenciais para fixações pesadas.' },
  { itemId: 'material_sucata', name: 'Sucata', icon: '⚙️', category: 'supplies', rarity: 'common', consumable: false, isQuestItem: false, description: 'Componentes mecânicos, engrenagens, fios e peças reaproveitadas de veículos e máquinas.' },
  { itemId: 'material_tecido', name: 'Tecido', icon: '🧵', category: 'supplies', rarity: 'common', consumable: false, isQuestItem: false, description: 'Lonas impermeáveis, fardos de tecido e cordas resistentes para cobertura e isolamento.' },
  { itemId: 'material_suprimentos', name: 'Suprimentos', icon: '📦', category: 'supplies', rarity: 'common', consumable: false, isQuestItem: false, description: 'Compostos químicos, argamassa, aditivos, fertilizantes e insumos estruturais de apoio.' },
]
